...
const CACHE = 'gestao-rapida-programacao-v1';
...
const ARQUIVOS = [
  ...
  './js/relatorio.js', './js/cadastros.js',
  './icons/gr-192.v1.png', './icons/gr-512.v1.png', './icons/gr-180.v1.png', './icons/favicon-gr.v1.ico',
